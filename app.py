...
# --- Flask CLI Commands for Database Management (UPDATED CREDENTIALS) ---
...
def init_db_command():
    ...
    with app.app_context():
        ...
        new_admin_username = 'k1youthassociation'
        ...
        # This part is commented out, but you could uncomment it if you want to remove the old 'admin' entry.
        # old_admin_user = db.session.query(User).filter_by(username='executives').first() # Changed from 'admin' to 'executives'
        # if old_admin_user and old_admin_user.username != new_admin_username:
        #     db.session.delete(old_admin_user)
        #     db.session.commit()
        #     print("Old 'executives' user removed from database.") # Adjusted message
